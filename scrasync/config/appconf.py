...
RABBITMQ_METRICS_PORT = os.environ.get('RABBITMQ_METRICS_PORT', 15672)
RABBITMQ_PROM_METRICS_PORT = 15692
RABBITMQ_SCRASYNC_QUEUE_NAME = os.environ.get('RABBITMQ_SCRASYNC_QUEUE_NAME', 'scrasync')
